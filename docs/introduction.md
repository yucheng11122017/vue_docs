...
<tooltip content="pronounced /vjuː/, like **view**">Vue</tooltip> is a JavaScript framework for building user interfaces. It builds on top of standard HTML, CSS, and JavaScript and provides a declarative and component-based programming model that helps you efficiently develop user interfaces, be they simple or complex.
...
<box type="tip">
  ...
  You can check your knowledge level with [this JavaScript overview](https://developer.mozilla.org/en-US/docs/Web/JavaScript/A_re-introduction_to_JavaScript). 
...
<a href="/tutorial/">
  <box header="Try the tutorial">
    For those who prefer learning things hands-on.
  </box>
</a>

<a href="/guide/quick-start.html">
  <box header="Read the Guide">
...
<a href="/examples/">
  <box header="Check out the Examples">
